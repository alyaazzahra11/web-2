...
// mengecek apakah tombol submit sudah ditekan atau belum jika belum maka akan diarahkan kembali ke form_registrasi.php
...
// mengambil data dari file data_form_regist.php
...
<body>
  <div class="mx-auto mt-5 border border-2 border-dark p-3 bg-success text-white rounded" style="width: 48%;">
