...
<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
    <div class="card-header text-white" style="background-color:rgb(33, 51, 86);">
        <i class="fas fa-table me-1" ></i>
        Data
    </div>
    <div class="card-body">
        <table id="datatablesSimple">
            <thead style="background-color:rgb(182, 202, 241);">
                <tr>
                    <th>Nama</th>
                    <th>NIDN</th>
                    <th>Email</th>
                    ...
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">
                                Copyright &copy; Alya Az-Zahra <?= date('Y'); ?>
                            </div>
                            <div>
    ...
    new Chart(document.getElementById("myBarChart"), {
        ...
        data: {
            ...
            datasets: [{
                label: "Jumlah Dosen",
                data: jumlahData,
                backgroundColor: "rgb(99, 188, 230)",
                borderColor: "rgb(27, 69, 97)",
                borderWidth: 1
            }]
        },
        options: {
